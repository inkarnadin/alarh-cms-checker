...
public class BitrixYearVersionMap implements VersionMap {
    ...
    BitrixYearVersionMap() {
        ...
        versionMap.put(2008L, "6.0.0, 7.0.0");
        versionMap.put(2009L, "8.0.0");
        versionMap.put(2010L, "9.0.0");
        versionMap.put(2011L, "10.0.0, 11.0.0");
        versionMap.put(2012L, "11.0.0, 12.0.0");
        versionMap.put(2013L, "12.0.0, 14.0.0");
        versionMap.put(2014L, "14.0.0");
        versionMap.put(2015L, "14.0.0, 15.0.0");
        versionMap.put(2016L, "15.0.0, 16.0.0");
        versionMap.put(2017L, "15.0.0, 16.0.0, 17.0.0, 18.0.0");
        versionMap.put(2018L, "17.0.0, 18.0.0");
        versionMap.put(2019L, "18.0.0, 19.0.0, 20.0.0");
